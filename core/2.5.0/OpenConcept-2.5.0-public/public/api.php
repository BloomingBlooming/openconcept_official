...
if ($action === 'delete-page-permanently' && $method === 'POST') {
    ...
    try {
        ...
        // Files survive page deletion with page_id=NULL. Journal loss of publication
        // and inherited access while their old page references are still available.
        $extensionEvents = $pluginFileService->journalPageSources($ids, ['operation' => 'delete-page', 'change_id' => bin2hex(random_bytes(16))], true);
