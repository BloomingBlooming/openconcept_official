(() => {
    ...
    const appVersion = window.OPENCONCEPT_BOOT?.app_version || '2.6.0';
    ...
    document.addEventListener('keydown', event => {
        ...
        if (event.key === 'Escape') {
            if (state.dialog === 'plugin-update-confirmation') { event.preventDefault(); cancelPluginUpdate(); }
