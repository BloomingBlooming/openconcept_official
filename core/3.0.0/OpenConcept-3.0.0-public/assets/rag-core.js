    ...
    function generationRows(status) {
        ...
        return generations.map(generation => {
            ...
            return `<div class="rag-core-generation"><div><strong>${esc(generationId)}</strong><small>${esc(t('ui.generationMetrics', {
                ...
                state: t(`ui.generationState.${['building', 'ready', 'active', 'failed', 'retired'].includes(state) ? state : 'unknown'}`, {}, state),
                    ...
                    <fieldset class="rag-core-section" id="ragCoreRetrievalSection">
                        ...
                        <div data-mode-panel="custom" class="rag-core-advanced">
                            <div class="rag-core-fields">
                                ...
                                <label>${esc(t('ui.authentication', {}, 'Authentication'))}<select class="select" name="custom_auth_mode"><option value="bearer"${selected(custom.auth_mode || 'bearer', 'bearer')}>${esc(t('ui.bearerToken', {}, 'Bearer token'))}</option><option value="api_key"${selected(custom.auth_mode, 'api_key')}>${esc(t('ui.apiKeyHeader', {}, 'API key header'))}</option><option value="none"${selected(custom.auth_mode, 'none')}>${esc(t('ui.noAuthentication', {}, 'None (local only)'))}</option></select></label>
