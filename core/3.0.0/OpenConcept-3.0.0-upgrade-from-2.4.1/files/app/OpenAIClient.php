    ...
    ): array
    {
        ...
        return $this->requestStructured(
            ...
            implode("\n", [
                ...
                'matching_revision_count describes repeated saved versions of the same page text, not independent corroborating sources. The cited ID and timestamp belong to the representative snapshot.',
